...
/**
 * Servlet implementation class ViewEmployeeDeniedRequest
 */
public class ViewEmployeeDeniedRequest extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReimbursementRequestEntity> deniedList =reimbursementRequestServiceImpl.getParticularUserDeniedRequests(userName);
		for(ReimbursementRequestEntity re : deniedList)
		{
		...
		out.println("<caption><center><h4><b><i>Rejected Requests</i></b></h4></center></caption>");
		out.println("<tr>");
