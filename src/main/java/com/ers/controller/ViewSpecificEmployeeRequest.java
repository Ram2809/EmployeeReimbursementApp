...
/**
 * Servlet implementation class ViewSpecificEmployeeRequest
 */
public class ViewSpecificEmployeeRequest extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<center>");
		out.println("<H1>Get Reimbursement Request of Specific Employee</H1>");
		out.println("<form action='http://localhost:8080/EmployeeReimbursementApp/ViewSpecificUserRequest' method='GET'>");
