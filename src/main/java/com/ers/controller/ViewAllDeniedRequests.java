...
/**
 * Servlet implementation class ViewAllDeniedRequests
 */
public class ViewAllDeniedRequests extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<ReimbursementRequestEntity> allDeniedRequestsList = reimbursementRequestServiceImpl
		...
		out.println("<caption><center><h4><b><i>Denied Requests</i></b></h4></center></caption>");
		out.println("<tr>");
