...
/**
 * Servlet implementation class ViewEmployeeAllRequest
 */
public class ViewEmployeeAllRequest extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*out.println("<form>");
		out.println("<select name='allRequest' onclick='goTodisplay>");
		for(ReimbursementRequestEntity re : allRequestList) {
		...
		out.println("<caption><center><h4><b><i>All Employee Requests</i></b></h4></center></caption>");
		out.println("<tr>");
